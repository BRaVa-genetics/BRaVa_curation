...
# Full tables
fwrite(phenotype_ancestry_information_binary, file="supplementary_table_4.tsv", sep='\t', quote=FALSE)
fwrite(phenotype_ancestry_information_cts, file="supplementary_table_5.tsv", sep='\t', quote=FALSE)

# Summary tables
fwrite(binary_summary, file="supplementary_table_6.tsv", sep='\t', quote=FALSE)
fwrite(cts_summary, file="supplementary_table_7.tsv", sep='\t', quote=FALSE)
