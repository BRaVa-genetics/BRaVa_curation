...
file_check_information <- list(
	...
	phenotype = list(
		...
		`CRF` = c("CRF", "Chronic Renal Failure", "Chronic_Renal_Failure", "Chronic_kidney_disease", "Chronic Kidney Disease", "Chronic_Kidney_Disease"),
...
run_inv_var <- function(
	...
	dt[[output_meta_pvalue]][is.na(dt[[output_meta_pvalue]]) & is.infinite(dt[[output_se_meta]])] <- 1
