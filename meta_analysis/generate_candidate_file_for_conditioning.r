...
fwrite(dt_final, "/well/lindgren/dpalmer/BRaVa_meta-analysis_outputs/candidates_from_meta_051125.tsv.gz", sep='\t', quote=FALSE)

# Double check to ensure that the ALL meta results are all present within this less stringent superset
dt_all <- fread("/well/lindgren/dpalmer/BRaVa_meta-analysis_outputs/significant_assocs_from_full_meta_051125.tsv.gz")
...
fwrite(dt_final,
	file="/well/lindgren/dpalmer/BRaVa_meta-analysis_outputs/gene_phenotype_pairs_051125.csv.gz",
	sep=",", quote=FALSE)
