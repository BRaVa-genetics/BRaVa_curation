...
plot_unique <- fread("~/Repositories/BRaVa_curation/data/meta_analysis/meta_results/plot_unique_hits_data.tsv.gz")
...
for (cc in c(TRUE, FALSE)) {
	pdf(width=ifelse(cc, 5, 3.5), height=4, file=ifelse(cc, "binary_unique_hits_count.pdf", "cts_unique_hits_count.pdf"))
